...
<img src="assets/heatmap.svg" alt="Contribution heatmap" width="760"/>
...
<sub>Heatmap regenerates daily via GitHub Actions using live contribution data — see <code>.github/workflows/update-heatmap.yml</code>.</sub>
